...
public class JwtService {
    ...
    public boolean isValid(String token, String email) { try { return email.equals(extractEmail(token)); } catch (JwtException | IllegalArgumentException ex) { return false; } }
}